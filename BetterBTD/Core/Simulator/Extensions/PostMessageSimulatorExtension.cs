...
public static class PostMessageSimulatorExtension
{
    ...
    public static PostMessageSimulator SimulateAction(this PostMessageSimulator self, BTDActions action, KeyType type = KeyType.KeyPress)
    {
    ...
    /// <param name="action">动作</param>
    /// <param name="type">按键类型</param>
    public static PostMessageSimulator SimulateActionBackground(this PostMessageSimulator self, BTDActions action, KeyType type = KeyType.KeyPress)
    {
        var key = action.ToActionKey();
        switch (type)
        {
